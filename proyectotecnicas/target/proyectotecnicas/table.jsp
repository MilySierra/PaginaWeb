...
<body>
    ...
    <div class="container" style="width: 50%; margin: 50px auto 20px; padding: 20px;">
        <table class="table table-striped table-bordered table-hover" style="font-size: 10px;">
          <thead style="background-color: #ababab; color: #FFFFFF;">
            <tr>
          ...
          <tr>
            <td><%= (Integer) session.getAttribute("numeroCuenta") %></td>
            <td><%= (String) session.getAttribute("tipoCuenta") %></td>
            <td><%= (Double) session.getAttribute("saldo") %></td>
          </tr>    
          </tbody>
        </table>
      </div>
    ...
    <div class="container text-center mt-4">
        <div class="row">
            <div class="col">
                <a href="consignar.jsp">Consignar</a>
            </div>
            <div class="col">
                <a href="retiro.jsp">Retirar</a>
            </div>
        </div>
    </div>
