   ...
   <div class="container-fluid py-5">
    <div class="container py-5">
        <div class="text-center mb-5">
            <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Ingrese el número de su cuenta</h5>
        </div>
                    ...
                    <div id="success"></div>
                        <form method="post">
                            ...
                            <div class="text-center">
                                <button type="submit" formaction="CuentaServlet" class="btn btn-primary py-3 px-5">Continuar</button>
                            </div>
                        </form>
