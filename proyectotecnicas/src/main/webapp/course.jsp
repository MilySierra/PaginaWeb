<%-- 
    Document   : course
    Created on : 23/05/2024, 12:28:28 a. m.
    Author     : USUARIO
--%>
...
<head>
    <meta charset="utf-8">
    <title>BancoXLX - Online Courses HTML Template</title>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="course.jsp" class="nav-item nav-link active">Educación Financiera</a>
                            <a href="contact.jsp" class="nav-item nav-link">Inf. Personal</a>
                        </div>
                    </div>
                </nav>
            </div>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 90px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Educacion Financiera</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Inicio</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Educación Financiera</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mb-5">
                <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Consejos</h5>
                <h1>Cuídate del fraude</h1>
            </div>
            <div class="row">
                    ...
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i></i>¡No caigas! Esta es una llamada estafa</small>
                            </div>
                            <a class="h5" href="https://youtu.be/aHSXw_KNt8A?si=funZc-gvFfx9scYc">¿Cómo saber si una llamada en nombre del banco es un intento de estafa? Te lo contamos aquí</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i></i>¿Qué es el pishing?</small>
                            </div>
                            <a class="h5" href="https://youtu.be/7OzGMlq1how?si=9kWZAp62ydCy6d68">La ciberestafa más comun que se realiza a través de correo electrónico y mensaje de texto. Te lo contamos aquí</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i></i>¿Cuál es la forma de robar en las redes sociales?</small>
                            </div>
                            <a class="h5" href="https://youtu.be/BtwVZXjn37E?si=P0us8XzjTCO5TUQt">Comprar por redes sociales no tiene por qué ser peligroso. Hazlo así de forma segura.</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i></i>Evita una estafa de empleo</small>
                            </div>
                            <a class="h5" href="https://youtu.be/0OyQTJmUiR0?si=TEDRmzW5aiijfLMr">¿Te contactan para un empleo y te piden consignar plata en el proceso? Que no te pase a ti.</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i></i>Compra segura con datafono</small>
                            </div>
                            <a class="h5" href="https://youtu.be/Ug9nuOHiE64?si=Gz_gfgKIptiaoOO3">No pongas en riesgo tus datos cuando uses tarjetas. Acá algunos errores y cómo evitarlos.</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i></i>¿Cómo detectar una estafa por whatsapp?</small>
                            </div>
                            <a class="h5" href="https://youtu.be/i_ICsgNdEZM?si=90rKVQ55ycusraCt">Algunas personas se aprovechan, por medio de chats para estafarte.Conoce cómo prevenirlo.</a>
                        </div>
                    </div>
                </div>
            </div>
