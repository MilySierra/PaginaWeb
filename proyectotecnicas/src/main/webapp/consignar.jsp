...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="text-center mb-5">
            <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Consignación</h5>
            <h1>Ingrese el monto a consignar</h1>
        </div>
                    ...
                    <div id="success"></div>
                        <form method="post">
                            <div class="control-group mb-3">
                                <input type="hidden" name="tipoTransaccion" value="Deposito">
                                <input type="text" name="usuario_disabled" class="form-control border-0 p-4" value="Deposito" disabled>
                            </div>
                            <div class="control-group mb-3">
                                <input type="text" name="cantidad" class="form-control border-0 p-4" placeholder="Cantidad" required="required">
                            </div>
                            <div class="control-group mb-3">
                                <select name="moneda" id="moneda" class="form-control border-0 p-4" placeholder="Seleccionar moneda" required="required">
                            ...
                            <div class="control-group mb-3">
                                <input type="text" name="numeroCuenta" class="form-control border-0 p-4" placeholder="Número de cuenta" required="required">
                            </div>
                            <div class="text-center">
                                <button type="submit" formaction="transferenciaServlet" class="btn btn-primary py-3 px-5">Consignar</button>
                            </div>
                        </form>
